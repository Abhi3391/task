...
export const LANGUAGE_SELECTOR = 'https://api-staging.bitdelta.com/api/v1/public/lang';
...
export const COIN_TABLE = 'https://api-staging.bitdelta.com/api/v1/market/pairs';

export const COIN_CARD = 'https://api-staging.bitdelta.com/api/v1/market/pairs';
